...
import org.springframework.web.client.RestClientException; // Ensure this is imported
...
public class QualityClassifierStage extends MosipVerticleAPIManager {
    ...
    public MessageDTO process(MessageDTO object) {
        ...
        try {
            ...
            // This catches Checked Exceptions from the SDK (data issues, etc)
            registrationStatusDto.setStatusCode(RegistrationStatusCode.PROCESSING.name());
            ...
            // ** THIS IS THE FIX **
            // Catches 503 and other Runtime Exceptions from Spring RestTemplate
            regProcLogger.warn(LoggerFileConstant.SESSIONID.toString(), LoggerFileConstant.REGISTRATIONID.toString(),
                    regId, "Biometric SDK Service Unavailable (REST Error). Marking packet for REPROCESS. " + e.getMessage());
